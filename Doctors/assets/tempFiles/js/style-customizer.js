   ...
   /**************************************
		...
		**************************************/
	    function updatechart(m){
	    	var data = [ 73, 55, 89, 95 ];
	    	var colorcode = ['26ade4','50816b','07cb79','bea042','ff6370','abc502','ff669a','ffde00']
		    $.each( data, function( i, val ) {			 
			  $('.chart').eq(i).data('easyPieChart').options.barColor = '#' + colorcode[m];
			   $('.chart').eq(i).data('easyPieChart').update(val);
			});
	    }
